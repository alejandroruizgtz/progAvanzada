# El comando printp imprime un mensaje en la pantalla o en otro dispocitivo de salida. El mensaje puede ser una cadena de caracteres o cualquier objeto que sea convertible a cadena de caracteres
